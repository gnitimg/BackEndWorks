            ...
            while (true) {
                if (usertype.equals("visitor")) {
                    ...
                    if (operate == 1) {
                        ...
                        new Operate().borrowBook(list, sc.nextLine());
                    } else if (operate == 2) {
                        System.out.println("请输入需要还的书名");
                        new Operate().returnBook(list, sc.nextLine());
                    } else if (operate == 3) {
                        System.out.println("请输入图书名");
                        new Operate().checkBook(list, sc.nextLine());
                    } else if (operate == 0) {
                        usertype = "null";
                    ...
                    if (operate == 1) {
                        ...
                        new Operate().addBook(list, name, ISBN);
                    } else if (operate == 2) {
                        System.out.println("请输入需要删除图书的ISBN");
                        new Operate().deleteBook(list, sc.nextLine());
                    } else if (operate == 3) {
                        System.out.println("请输入图书名");
                        new Operate().checkBook(list, sc.nextLine());
                    } else if (operate == 0) {
